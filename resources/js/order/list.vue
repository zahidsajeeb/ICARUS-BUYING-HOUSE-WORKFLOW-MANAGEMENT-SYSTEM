                    ...
                    <div class="col-md-12">
                        <div class="card" style="border: 2px solid darkgrey;">
                            <div class="card-header" style="background:white !important;">
                                <div class="row">
                                    <div class="col-md-6">
                                        <p class="card-title mb-0" style="color:black; vertical-align:middle;">Order Lists</p>
                                    </div>
                                </div>
                            </div>
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table id="order_list" class="table table-stripped table-bordered table-striped">
                                        ...
                                        <tr>
                                            ...
                                            <th style="background:#0082f1 !important; color:white;">LC No</th>
                                            ...
                                            <td class="text-center">
                                                <a class="btn btn-success"
                                                   style="color:white;background:darkgreen;border-radius:0px;">
                                                    <router-link :to="{name:'edit_order', params: {id:post.id}}" style="color:white;">
